...
class TestCapabilityScheduling:
    ...
    def test_capabililty_is_found_when_capability_present_in_time_slot(
        ...
        not_found = capability_finder.find_available_capabilities(unique_skill, another_day)
    ...
    def test_find_capability_ignoring_availability(
        ...
        in_overlapping_slot = capability_finder.find_capabilities(admin, partially_overlapping_day)
