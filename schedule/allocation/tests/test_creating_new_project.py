...
class TestCreatingNewProject:
    def test_allocate_capability_to_project(self, allocation_facade: AllocationFacade) -> None:
        ...
        event = allocation_facade.allocate_to_project(project_id, allocatable_resource_id, java_skill, one_day)
    ...
    def test_can_release_capability_from_project(self, allocation_facade: AllocationFacade) -> None:
        one_day = TimeSlot.create_daily_time_slot_at_utc(2021, 1, 1)
        allocatable_resource_id = ResourceId.new_one()
        project_id = ProjectAllocationsId.new_one()
        ...
        result = allocation_facade.release_from_project(project_id, allocate_id, one_day)
