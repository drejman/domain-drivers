...
def resource_availability() -> ResourceAvailability:
    return ResourceAvailability(
        TestResourceAvailability.RESOURCE_AVAILABILITY_ID,
...
class TestResourceAvailability:
    ...
    def test_can_block_when_available(self, resource_availability: ResourceAvailability) -> None:
        result = resource_availability.block(self.OWNER_1)

        assert result is True

    def test_cant_be_blocked_when_blocked_by_someone_else(self, resource_availability: ResourceAvailability) -> None:
    ...
    def test_can_be_released_by_owner(self, resource_availability: ResourceAvailability) -> None:
        resource_availability.block(self.OWNER_1)
    ...
    def test_cant_be_released_by_someone_else(self, resource_availability: ResourceAvailability) -> None:
        resource_availability.block(self.OWNER_1)
    ...
    def test_can_be_blocked_by_someone_else_after_releasing(self, resource_availability: ResourceAvailability) -> None:
        resource_availability.block(self.OWNER_1)
    ...
    def test_can_be_disabled_when_available(self, resource_availability: ResourceAvailability) -> None:
    ...
    def test_can_disable_when_blocked(self, resource_availability: ResourceAvailability) -> None:
    ...
    def test_cant_be_blocked_when_disabled(self, resource_availability: ResourceAvailability) -> None:
    ...
    def test_can_be_enabled_by_initial_requester(self, resource_availability: ResourceAvailability) -> None:
    ...
    def test_cant_be_enabled_by_another_requester(self, resource_availability: ResourceAvailability) -> None:
        resource_availability.disable(self.OWNER_1)
    ...
    def test_can_be_blocked_again_after_enabling(self, resource_availability: ResourceAvailability) -> None:
        resource_availability.disable(self.OWNER_1)
