...
class TestOptimization:
    def test_nothing_is_chosen_when_no_capacities(self, optimization_facade: OptimizationFacade) -> None:
        items = [
            Item(
                "Item1",
                100,
    ...
    def test_everything_is_chosen_when_all_weights_are_zero(self, optimization_facade: OptimizationFacade) -> None:
    ...
    def test_if_enough_capacity_all_items_are_chosen(self, optimization_facade: OptimizationFacade) -> None:
        items = [
            Item(
                "Item1",
                100,
    ...
    def test_most_valuable_items_are_chosen(self, optimization_facade: OptimizationFacade) -> None:
        item1 = Item("Item1", 100, TotalWeight.of(CapabilityWeightDimension("JAVA", "Skill")))
        item2 = Item("Item2", 500, TotalWeight.of(CapabilityWeightDimension("JAVA", "Skill")))
        item3 = Item("Item3", 300, TotalWeight.of(CapabilityWeightDimension("JAVA", "Skill")))
        c1 = CapabilityCapacityDimension("anna", "JAVA", "Skill")
        c2 = CapabilityCapacityDimension("zbyniu", "JAVA", "Skill")

        result = optimization_facade.calculate([item1, item2, item3], TotalCapacity.of(c1, c2))
