...
class TestSpecializedWaterfall:
    ...
    def test_specialized_waterfall_project_process(self, planning_facade: PlanningFacade) -> None:
        ...
        planning_facade.define_project_stages(project_id, stage_before_critical, critical_stage, stage_after_critical)
        critical_resource_name = ResourceName("criticalResourceName")
        critical_capability_availability = self._resource_available_for_capability_in_period(
        ...
        self._verify_resources_not_available(project_id, critical_capability_availability, self.JAN_4_8)
        ...
        _ = schedule_assert.assert_has_stage("Stage 1").assert_with_slot(self.JAN_1_2)
        _ = schedule_assert.assert_has_stage("Stage 2").assert_with_slot(self.JAN_1_6)
        _ = schedule_assert.assert_has_stage("Stage 3").assert_with_slot(self.JAN_1_4)

    def _assert_resources_available(self, project_id: ProjectId, resource: ResourceId) -> None:
        pass
