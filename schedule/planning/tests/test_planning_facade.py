...
class TestPlanningFacade:
    def test_can_create_project_and_load_project_card(self, planning_facade: PlanningFacade) -> None:
    ...
    def test_creates_and_saves_more_complex_parallelization(self, planning_facade: PlanningFacade) -> None:
        ...
        project_id = planning_facade.add_new_project("project", stage_1, stage_2, stage_3)
    ...
    def test_plans_needed_resources_in_time(self, planning_facade: PlanningFacade) -> None:
        ...
        loaded = planning_facade.load(project_id)
        assert loaded.needed_resources == ChosenResources(needed_resources, first_half_of_the_year)
    ...
    def test_calculates_schedule_after_passing_possible_start(self, planning_facade: PlanningFacade) -> None:
