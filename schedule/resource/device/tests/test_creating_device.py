...
class TestCreatingDevice:
    def test_creates_and_loads_devices(self, device_facade: DeviceFacade) -> None:
        device_id = device_facade.create_device("super-excavator-1000", Capability.assets("BULLDOZER", "EXCAVATOR"))
    ...
    def test_find_all_capabilities(self, device_facade: DeviceFacade) -> None:
        device_facade.create_device("super-excavator-1000", Capability.assets("SMALL-EXCAVATOR", "BULLDOZER"))
        device_facade.create_device(
            "super-excavator-1000",
            Capability.assets("MEDIUM-EXCAVATOR", "UBER-BULLDOZER"),
        )
        device_facade.create_device("super-excavator-1000", Capability.assets("BIG-EXCAVATOR"))
